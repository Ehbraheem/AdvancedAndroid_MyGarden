...
/**
 * Created by prof.BOLA on 6/28/2017.
 */
...
class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        int createdIndex = mCursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_CREATION_TIME);
        int waterdIndex = mCursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME);
        ...
        long createdAt = mCursor.getLong(createdIndex);
        long wateredAt = mCursor.getLong(waterdIndex);
